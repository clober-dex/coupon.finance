...
export const DepositCard = ({
  ...
  return (
    <div className="transition ease-in-out delay-150 duration-300 sm:hover:-translate-y-1 sm:hover:scale-110 group flex flex-col h-[300px] w-full sm:w-[328px] p-4 justify-center items-center gap-4 bg-white dark:bg-gray-800 rounded-xl shadow">
