...
export const LegendaryDragonCard = () => (
  <div className="mb-4 flex justify-center lg:mb-8">
    <div className="flex items-center gap-6 p-4 rounded-2xl bg-gradient-to-r from-indigo-300 to-cyan-200 dark:from-indigo-400 dark:to-cyan-300 lg:p-6 lg:rounded-3xl">
