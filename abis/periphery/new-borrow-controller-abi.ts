export const NEW_BORROW_CONTROLLER_ABI = [
  {
    inputs: [
      {
    ...
    inputs: [
      {
        ...
        name: 'positionId', // borrowMore 과 동일
        type: 'uint256',
      },
      {
        internalType: 'uint256',
        name: 'collateralAmount', // borrow 와 동일
        type: 'uint256',
      },
      {
        internalType: 'uint256',
        name: 'borrowAmount', // borrow 와 동일
        type: 'uint256',
      },
      {
        internalType: 'uint256',
        name: 'maxPayInterest', // borrow 와 동일
        type: 'uint256',
      },
      {
        internalType: 'uint256',
        name: 'minEarnInterest', // shortenLoanDuration or repay 와 동일
        type: 'uint256',
      },
      {
        internalType: 'Epoch',
        name: 'expiredWith', // couponKey 와 동일
        type: 'uint16',
      },
      {
        components: [
      ...
      },
      {
        ...
        name: 'positionPermitParams', // addCollateral 과 동일
        type: 'tuple',
      },
      {
        components: [
        ...
        name: 'collateralPermitParams', // addCollateral 과 동일
        type: 'tuple',
      },
      {
        components: [
        ...
        internalType: 'struct ERC20PermitParams',
        name: 'debtPermitParams', // extendLoanDuration 과 동일
        type: 'tuple',
      },
    ],
    name: 'adjustPosition',
